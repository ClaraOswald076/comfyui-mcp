...
<ParamField path="COMFYUI_CODE_PATH" type="string" default="COMFYUI_PATH">
  ...
  و`custom_nodes` منفصلة عن بيانات المستخدم والنماذج. تستخدمه عمليات comfy-cli
  وقفل سير العمل ولقطات Manager القديمة؛ أما تحديث النواة فيفضّل المستودع المرصود
  من الخادم المحلي ويستخدم هذا المسار كخيار احتياطي. يُتجاهل في الوضع البعيد.
</ParamField>
