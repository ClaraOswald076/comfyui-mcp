...
| Audio input | ❌ | ❌ | ⚠️ ACP-gated | ✅ Ollama (checked) · ⚠️ others (unverified) |
...
- **LM Studio / llama.cpp / OpenRouter / custom OpenAI-compatible endpoints —
  attempted, NOT capability-checked.** These speak `/v1/chat/completions`,
