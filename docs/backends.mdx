...
- **Claude, ChatGPT (Codex), Codex CLI, Antigravity, pi, Grok direct** — no
  audio input at all. Attaching audio is refused before the turn is built, and
  both you and the model are told, naming the provider and what would work
  instead.
