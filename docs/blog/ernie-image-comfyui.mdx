...
> (`install_comfyui (action:"apply_manifest") path:"packs/ernie/manifest.yaml"`, or run the generated
...
install_comfyui (action:"apply_manifest") path:"packs/ernie/manifest.yaml"
