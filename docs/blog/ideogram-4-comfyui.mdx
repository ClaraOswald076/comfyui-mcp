...
> (`install_comfyui (action:"apply_manifest") path:"packs/ideogram/manifest.yaml"`, or run the generated
...
install_comfyui (action:"apply_manifest") path:"packs/ideogram/manifest.yaml"
