...
> `install_comfyui (action:"apply_manifest") path:"packs/ltx-2.3-txt2vid/manifest.yaml"`), then drive the
...
install_comfyui (action:"apply_manifest") path:"packs/ltx-2.3-txt2vid/manifest.yaml"   # text→video
install_comfyui (action:"apply_manifest") path:"packs/ltx-2.3-img2vid/manifest.yaml"   # image→video
