...
> (`install_comfyui (action:"apply_manifest") path:"packs/qwen-image/manifest.yaml"`) for the 20B T2I + WAN
...
install_comfyui (action:"apply_manifest") path:"packs/qwen-image/manifest.yaml"

# Instruction editing + manual-mask "super inpainting"
install_comfyui (action:"apply_manifest") path:"packs/qwen-image-edit/manifest.yaml"
```
