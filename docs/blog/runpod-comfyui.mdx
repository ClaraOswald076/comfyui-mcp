---
title: "ComfyUI on RunPod: Rent a Cloud GPU (2026 Guide)"
...
The `runpod_pod_create` tool deploys the project's own RunPod template
...
one-tap **Local ⇄ Pod** switch (`runpod_use_local`) moves you between them
...
just redeploy with `runpod_pod_create`.
</Warning>
...
or large upscales. You don't have to pick perfectly: `runpod_pod_create` **falls
