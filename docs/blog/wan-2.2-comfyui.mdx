...
> `wan-longer-videos` pack (`install_comfyui (action:"apply_manifest") path:"packs/wan-longer-videos/manifest.yaml"`,
...
install_comfyui (action:"apply_manifest") path:"packs/wan-longer-videos/manifest.yaml"
