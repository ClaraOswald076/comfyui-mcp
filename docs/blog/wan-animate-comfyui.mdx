...
> (`install_comfyui (action:"apply_manifest") path:"packs/wan-animate/manifest.yaml"`, or run the generated
...
install_comfyui (action:"apply_manifest") path:"packs/wan-animate/manifest.yaml"
