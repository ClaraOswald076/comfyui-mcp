...
> `wan-transparent` pack (`install_comfyui (action:"apply_manifest") path:"packs/wan-transparent/manifest.yaml"`,
...
install_comfyui (action:"apply_manifest") path:"packs/wan-transparent/manifest.yaml"
