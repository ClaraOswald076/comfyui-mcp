...
**no browser prompt, in any browser**; the startup banner also prints the URL for
recovery or manual panel configuration. For a **local** ComfyUI it
...
Point `connect` at its URL and click **Connect** in the panel:
