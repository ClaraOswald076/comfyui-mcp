...
<ParamField path="COMFYUI_CODE_PATH" type="string" default="COMFYUI_PATH">
  ...
  `.venv` y `custom_nodes` están separados de los datos y modelos. La usan las
  mutaciones de comfy-cli, la procedencia de locks y los snapshots heredados de Manager;
  las actualizaciones del núcleo prefieren el checkout observado del servidor local.
  Se ignora para mutaciones del sistema de archivos en modo remoto.
</ParamField>
