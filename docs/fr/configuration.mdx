...
<ParamField path="COMFYUI_CODE_PATH" type="string" default="COMFYUI_PATH">
  ...
  `.venv` et `custom_nodes` sont distincts des données et modèles. Les mutations comfy-cli,
  la provenance des verrous et les anciens snapshots Manager l'utilisent ; les mises à jour
  du cœur préfèrent le checkout observé du serveur local. Ignoré pour les mutations du
  système de fichiers en mode distant.
</ParamField>
