...
<ParamField path="action" type="enum" required>
  ...
  Options: `install`, `update`, `reinstall`, `fix`, `uninstall`, `enable`, `disable`, `list`, `sync_deps`.
</ParamField>
<ParamField path="id" type="string">
...
<ParamField path="action" type="enum" required>
  ...
  Options: `scaffold`, `verify`, `publish`, `list_files`, `read`, `search`, `write`, `patch`, `git`.
</ParamField>
...
<ParamField path="action" type="enum" required>
  ...
  Options: `start`, `good`, `bad`, `reset`, `status`.
</ParamField>
