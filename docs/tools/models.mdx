...
<ParamField path="action" type="enum" required>
  ...
  Options: `download`, `status`, `cancel`, `search`, `search_civitai`, `search_creators`, `download_civitai`, `resolve_missing`.
</ParamField>
...
<ParamField path="action" type="enum" required>
  ...
  Options: `list`, `remove`, `embeddings`, `list_paths`, `add_path`, `remove_path`.
</ParamField>
...
<ParamField path="action" type="enum" required>
  ...
  Options: `read`, `propose`, `fetch_civitai`.
</ParamField>
<ParamField path="category" type="string">
