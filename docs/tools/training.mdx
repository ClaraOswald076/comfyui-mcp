...
<ParamField path="action" type="enum" required>
  ...
  Options: `prepare`, `list`, `detail`, `update`, `delete`, `file`, `caption_image`, `caption_dataset`.
</ParamField>
...
<ParamField path="action" type="enum" required>
  ...
  Options: `start`, `status`, `cancel`, `delete`, `list_flows`, `job_config`, `preview_config`.
</ParamField>
...
<ParamField path="action" type="enum" required>
  ...
  Options: `doctor`, `bootstrap`, `build_image`.
</ParamField>
<ParamField path="target" type="enum" default="local">
