...
// structural: THIS CALL SITE PASSES NO SIGNAL, so the configured ceiling is what
// applies. Asserting that directly needs comfyuiFetch itself mocked, which must
// not leak into the behaviour tests next door.
