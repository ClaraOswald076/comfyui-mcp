 ...
 * node_pack (action:"verify"), model lookups, extra-paths, comfy-cli, install_comfyui (action:"apply_manifest")'s
 ...
 * by install_comfyui (action:"apply_manifest")'s pip installs and the cloned-node deps installer so those run
