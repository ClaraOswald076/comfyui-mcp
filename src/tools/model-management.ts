            ...
            content: [
              {
                ...
                text:
                  ...
                  (res.staleRecordLeft
                    ? ` The dead session's original record file could not be deleted (a transient filesystem error), so download_status may keep showing its stale row for a while — it no longer blocks cancelling or re-issuing, and it expires on its own.`
                    : "") +
                  `\n\n` +
                  (res.job?.viaManager
