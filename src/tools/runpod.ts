...
export function registerRunpodTools(server: McpServer): void {
  ...
  server.tool(
    "runpod_watch",
    "Watch a RunPod pod's live status in the control panel, stop watching it, or diagnose why it isn't usable. Driven by the `action` parameter. None of these actions starts or stops a pod — the runpod tool does that.\n" +
